...
class PostPoint extends Component {
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <Button onClick={this.toggle} color="success">Xem Điểm</Button>
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader toggle={this.toggle}>Xem Điểm</ModalHeader>
          <ModalBody>
            <Form action="" method="post">
              <FormGroup>
                <Label htmlFor="courseCode">Điểm số</Label>
...
export default connect(mapStateToProps, { enrollCourse })(PostPoint);